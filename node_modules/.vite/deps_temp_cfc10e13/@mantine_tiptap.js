import {
  EditorContent
} from "./chunk-UYAT4XHF.js";
import "./chunk-RGGRISVF.js";
import {
  Mark,
  Plugin,
  PluginKey,
    ...
    appendTransaction: (transactions, oldState, newState) => {
      ...
      changes.forEach(({ newRange }) => {
        ...
        if (textBlock && textBeforeWhitespace) {
          ...
          }).filter((link) => options2.validate(link.value)).forEach((link) => {
...
var RichTextEditorControl = factory((_props, ref) => {
  const props = useProps("RichTextEditorControl", defaultProps2, _props);
  const {
    classNames,
    className,
    style,
...
var RichTextEditorControlBase = (0, import_react2.forwardRef)(({ className, icon: Icon, ...others }, ref) => (0, import_jsx_runtime3.jsx)(RichTextEditorControl, { ref, ...others, children: (0, import_jsx_runtime3.jsx)(Icon, { style: { width: rem(16), height: rem(16) } }) }));
...
var RichTextEditorLinkControl = factory(
  (_props, ref) => {
    var _a;
    const props = useProps("RichTextEditorLinkControl", defaultProps3, _props);
    const {
      classNames,
      className,
      style,
...
var RichTextEditorColorPickerControl = (0, import_react4.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime6.jsxs)(Popover, { opened, withinPortal: true, trapFocus: true, onClose: close, ...popoverProps, children: [
...
var RichTextEditorColorControl = (0, import_react5.forwardRef)((props, ref) => {
  const { color, ...others } = useProps("RichTextEditorColorControl", defaultProps5, props);
  const { editor, labels } = useRichTextEditorContext();
...
var RichTextEditorControlsGroup = factory(
  (_props, ref) => {
    const props = useProps("RichTextEditorControlsGroup", defaultProps6, _props);
    const { classNames, className, style, styles, vars, ...others } = props;
    const ctx = useRichTextEditorContext();
...
var RichTextEditorToolbar = factory((_props, ref) => {
  const props = useProps("RichTextEditorToolbar", defaultProps7, _props);
...
var RichTextEditor = factory((_props, ref) => {
  const props = useProps("RichTextEditor", defaultProps8, _props);
  const {
    classNames,
    className,
    style,
  ...
  const mergedLabels = (0, import_react6.useMemo)(() => ({ ...DEFAULT_LABELS, ...labels }), [labels]);
  return (0, import_jsx_runtime10.jsx)(
    RichTextEditorProvider,
    {
      ...
      children: (0, import_jsx_runtime10.jsx)(Box, { ...getStyles("root"), ...others, ref, children })
    }
  );
});
