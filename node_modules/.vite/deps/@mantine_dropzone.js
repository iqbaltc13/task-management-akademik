...
function createDropzoneStatus(status) {
  const Component = (props) => {
    ...
    const _children = isElement(children) ? children : (0, import_jsx_runtime.jsx)("span", { children });
    if (ctx[status]) {
...
var Dropzone2 = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(DropzoneProvider, { value: { accept: isAccepted, reject: isRejected, idle: isIdle }, children: (0, import_jsx_runtime2.jsxs)(
    Box,
    {
      ...getRootProps(),
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)("input", { ...getInputProps(inputProps), name }),
        (0, import_jsx_runtime2.jsx)(
          "div",
          {
            ...getStyles("inner"),
...
var DropzoneFullScreen = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime3.jsx)(
    Box,
    {
