  ...
  return (
    <Card bg="none">
      ...
      {tasks.length > 0 ? (
              ...
              <Box key={task.id} className={classes.task}>
                <Group wrap="nowrap" justify="space-between">
                  <Stack gap={3}>
                    ...
                    <Group>
                      <Tooltip label="Grup permintann" openDelay={500} withArrow>
        ...
        <Center my={30}>
          <EmptyWithIcon title="Belum ada pelayanan" subtitle="Belum ada pelayanan untuk Anda" icon={IconSearch} />
        </Center>
      )}
    </Card>
  );
